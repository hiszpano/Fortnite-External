...
void Render::Menu() {
	...
	if (bMenu)
	{
		...
		ImGui::Begin("Evo.gj", 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar);
		...
		if (MenuTab == 0)
		{
			...
			ImGui::Checkbox("FOV Circle", &bfovcircle);
